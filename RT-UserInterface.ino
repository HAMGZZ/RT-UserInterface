...
volatile memoryMap registerMap = {
  ...
  .fanSpeed =                   0xFF, // FAN FULL SPEED AT START
};
...
void setup(void)
{
  ...
  analogWrite(fanPin, registerMap.fanSpeed);
  delay(5000);
...
void recordSystemSettings(void)
{
  ...
  if(registerMap.ledBrightnessGreen < 1)
  {
    digitalWrite(ledGreenPin, LOW); //Change LED brightness
  }
  else
  {
